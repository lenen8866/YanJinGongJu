...
public interface MusicPlayerPresenter {
     ...
     * @param listener 实现监听器的对象
     */
    void addPlayInfoListener(MusicPlayerInfoListener listener);

    /**
     * 移除监听播放对象事件
     */
    void removePlayInfoListener(MusicPlayerInfoListener listener);
    ...
    ArrayList<String> getAuthList();

    ArrayList<?> getBookAllAudio();

    ArrayList<?> getAllBooks();

    int getBookIndex();

    void setAuthList(ArrayList<String> authors);

    void setBookAllAudio(ArrayList<?> allAudio);

    void setAllBooks(ArrayList<?> rows);

    void setBookIndex(int bookIndex);

    void setCurrentAuthor(String author);

    String getCurrentAuthor();

    void removeAllPlayInfoListener();

    void setAllCate(Object audioCateData);

    Object getAllCate();

    void setCateIndex(int currentCateIndex);
