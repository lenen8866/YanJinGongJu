...
public final class MusicPlayerManager implements MusicPlayerPresenter {
     ...
     */
    public void initialize(final Context context, final MusicInitializeCallBack callBack) {
        if (isBindService) {
            return;
        }
        if (null != context && context instanceof Activity) {
            ((Activity) context).runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    isBindService = context.bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
                }
            });
        } else {
    ...
    public void unInitialize(Activity context, boolean destroy) {
        ...
        if (null != mBinder && mBinder.pingBinder()) {
            ...
            //回收监听器
            mBinder.addPlayInfoListener(null);
            mBinder.removeAllPlayInfoListener();
        }
    ...
    public void addPlayInfoListener(MusicPlayerInfoListener listener) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.addPlayInfoListener(listener);
        }
    }
    ...
    public void removePlayInfoListener(MusicPlayerInfoListener listener) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.removePlayInfoListener(listener);
        }
    }
    ...
    public List<?> getRandomPlayList() {
        if (null != mBinder && mBinder.pingBinder()) {
            return mBinder.getRandomPlayList();
        }
        return null;
    }
    ...
    public ArrayList<?> getBookAllAudio() {
        if (null != mBinder && mBinder.pingBinder()) {
            return mBinder.getBookAllAudio();
        }
        return null;
    }
    ...
    public void setAuthList(ArrayList<String> authors) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.setAuthList(authors);
        }
    }

    public void setBookAllAudio(ArrayList<?> allAudio) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.setBookAllAudio(allAudio);
        }
    }

    public void setAllBooks(ArrayList<?> rows) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.setAllBooks(rows);
        }
    }

    public void setBookIndex(int bookIndex) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.setBookIndex(bookIndex);
        }
    }
    ...
    public void setCurrentAuthor(String author) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.setCurrentAuthor(author);
        }
    }
    ...
    public String getCurrentAuthor() {
        if (null != mBinder && mBinder.pingBinder()) {
            return mBinder.getCurrentAuthor();
        }
        return "";
    }
    ...
    public void setAllCate(Object audioCateData) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.setAllCate(audioCateData);
        }
    }
    ...
    public void setCateIndex(int currentCateIndex) {
        if (null != mBinder && mBinder.pingBinder()) {
            mBinder.setCateIndex(currentCateIndex);
        }
    }
