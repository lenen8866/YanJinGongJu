...
public class HistoryBean implements Parcelable {
    ...
    public HistoryBean(String chapter, int volumeId, String volumeName, int chapterCount, int indexId, String content, int categoryId, int parentId, String parentPath, String time, int topIndex) {
