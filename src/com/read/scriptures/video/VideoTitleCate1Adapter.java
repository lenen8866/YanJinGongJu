 ...
 */
public class VideoTitleCate1Adapter extends IndexableAdapter<VideoCateBean.RowsBean> {
    private LayoutInflater mInflater;

    public VideoTitleCate1Adapter(Context context) {
    ...
    @Override
    public void onBindContentViewHolder(RecyclerView.ViewHolder holder, VideoCateBean.RowsBean entity) {
        ContentVH vh = (ContentVH) holder;
        vh.tv_title.setText(entity.cate_name);
