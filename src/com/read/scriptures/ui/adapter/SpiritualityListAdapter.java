 ...
 */
public class SpiritualityListAdapter extends EIBaseAdapter<Spirituality> {

    private Context mContext;

    public SpiritualityListAdapter(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_spir_gv_item, null);
