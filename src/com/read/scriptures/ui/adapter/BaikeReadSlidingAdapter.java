 ...
 */
public class BaikeReadSlidingAdapter extends SlidingAdapter<List<String>>
    ...
    public BaikeReadSlidingAdapter(final Context context, final Baike baike) {
    ...
    public void setTipsPostion(final int tipsPostion) {
        this.mTipsPostion = tipsPostion;
    }

    public void setTipsKeyword(final String tipsKeyword) {
        this.mTipsKeyword = tipsKeyword;
    }

    public void setReadModel(final int readModel) {
...
//        chapterReadAdapter.setTopAndBottomMargin(mTopAndBottomMargin);
    ...
    private List<String> getContentList(final int index) {
        List<String> content = null;
        if (baike != null) {
            content = SearchTextUtil.queryBaikeContent(mCcontext,
                    baike,
