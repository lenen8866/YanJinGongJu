...
public class HistoryReaderAdapter extends EIBaseAdapter<HistoryBean> {
    ...
    public HistoryReaderAdapter(Context context, List<HistoryBean> list,CheckedChangeCallback  checkedChangeCallback) {
        super(context, list);
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        Holder mHolder;
        if (convertView == null) {
            mHolder = new HistoryReaderAdapter.Holder();
            ...
            mHolder = (HistoryReaderAdapter.Holder) convertView.getTag();
        }
        ...
        mHolder.tv_chapter.setText(getList().get(position).getChapter());
