...
public class WxPlayer extends FrameLayout implements WxMediaController.WxMediaControll {
    ...
    private IUScreenChanageListener iuScreenChanageListener;
    ...
    public void screenChange(boolean isSmallScreen) {
        if(iuScreenChanageListener != null){
            iuScreenChanageListener.screenChange(isSmallScreen);
        }
...
//            mVideoHeight = height;
    ...
    public boolean isSmallScreen() {
        ...
        return mWxMediaController.isSmallScreen();
    }
    ...
    public void chanageScreen() {
        ...
        mWxMediaController.chanageScreen();
    }

    public void setIuScreenChanageListener(IUScreenChanageListener iuScreenChanageListener) {
        this.iuScreenChanageListener = iuScreenChanageListener;
    }

    public interface IUScreenChanageListener{
       public void screenChange(boolean isSmallScreen);
    }
}
