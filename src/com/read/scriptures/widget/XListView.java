...
public class XListView extends ListView implements OnScrollListener {
    ...
    public void onRefreshComplete() {
        if (mPullRefreshing == true) {
            ...
            editor.putString(mContext.getClass().getSimpleName() + ".lasttime", getStringDateLong());
            editor.apply();
            setRefreshTime("1分钟前");
    ...
    protected void onAttachedToWindow() {
        ...
        SharedPreferences preferences = mContext.getSharedPreferences(TAG, Context.MODE_PRIVATE);
        setRefreshTime(preferences.getString(mContext.getClass().getSimpleName() + ".lasttime", ""));
    }
