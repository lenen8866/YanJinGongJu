...
public class WelcomeBookProgressDialog extends Dialog {
     ...
     */
    @Deprecated
    public WelcomeBookProgressDialog(Activity activity) {
    ...
    public WelcomeBookProgressDialog(Activity activity, ProcessAction action, long sleep, String title) {
        super(activity, R.style.welcome_dialog);
        this.activity = activity;
        this.action = action;
        this.sleep = sleep;
    ...
    public WelcomeBookProgressDialog(Activity activity, ProcessAction action, String title) {
        super(activity, R.style.welcome_dialog);
        this.activity = activity;
        this.action = action;
        this.title = title;
    ...
    public WelcomeBookProgressDialog(Activity activity, String title) {
        super(activity, R.style.welcome_dialog);
        this.activity = activity;
        this.title = title;
    }

    public WelcomeBookProgressDialog(Activity activity, String title, Boolean openHint, String hint) {
        super(activity, R.style.welcome_dialog);
        this.activity = activity;
        this.title = title;
    ...
    public WelcomeBookProgressDialog(Activity activity, Boolean openHint, String hint) {
        super(activity, R.style.welcome_dialog);
        this.activity = activity;
        this.openHint = openHint;
        this.hint = hint;
    ...
    public void init() {
        ...
        View view = inflater.inflate(R.layout.welcome_book_dialog, null);
        setContentView(view);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                activity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        WelcomeBookProgressDialog.this.dismiss();
                    }
                });
            }
        }).start();
