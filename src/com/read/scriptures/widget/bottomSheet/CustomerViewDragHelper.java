 ...
 * Description:
 */
public class CustomerViewDragHelper {
    ...
    private final CustomerViewDragHelper.Callback mCallback;
     ...
     */
    public static CustomerViewDragHelper create(@NonNull ViewGroup forParent, @NonNull CustomerViewDragHelper.Callback cb) {
        return new CustomerViewDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static CustomerViewDragHelper create(@NonNull ViewGroup forParent, float sensitivity,
                                        @NonNull CustomerViewDragHelper.Callback cb) {
        final CustomerViewDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private CustomerViewDragHelper(@NonNull Context context, @NonNull ViewGroup forParent,
                           @NonNull CustomerViewDragHelper.Callback cb) {
        if (forParent == null) {
    ...
    public boolean shouldInterceptTouchEvent(@NonNull MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (mCallback != null){
                mCallback.isTouch(true,ev.getY());
            }
            cancel();
        }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_POINTER_UP: {
                if (mCallback != null){
                    mCallback.isTouch(false,ev.getY());
                }
                final int pointerId = ev.getPointerId(actionIndex);
