...
public class BottomSheetDialog2 extends AppCompatDialog {
    ...
    private BottomSheetBehavior2<FrameLayout> mBehavior;
    ...
    protected BottomSheetDialog2(@NonNull Context context, boolean cancelable,
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        final FrameLayout container = (FrameLayout) View.inflate(getContext(),
                R.layout.customer_bottom_sheet_dialog, null);
        ...
        mBehavior = BottomSheetBehavior2.from(bottomSheet);
    ...
    private BottomSheetBehavior2.BottomSheetCallback mBottomSheetCallback
            = new BottomSheetBehavior2.BottomSheetCallback() {
        @Override
        public void onStateChanged(@NonNull View bottomSheet,
                                   @BottomSheetBehavior2.State int newState) {
