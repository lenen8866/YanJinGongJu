...
public class WelcomeProgressDialog extends Dialog {
    ...
    public WelcomeProgressDialog(Activity activity, ProcessAction action, long sleep, String title) {
        super(activity, R.style.custom_dialog);
        this.activity = activity;
        this.action = action;
        this.sleep = sleep;
    ...
    public WelcomeProgressDialog(Activity activity, ProcessAction action, String title) {
        super(activity, R.style.custom_dialog);
        this.activity = activity;
        this.action = action;
        this.title = title;
    ...
    public WelcomeProgressDialog(Activity activity, String title) {
        super(activity, R.style.custom_dialog);
        this.activity = activity;
        this.title = title;
    }

    public WelcomeProgressDialog(Activity activity, String title, Boolean openHint, String hint) {
        super(activity, R.style.custom_dialog);
        this.activity = activity;
        this.title = title;
    ...
    public WelcomeProgressDialog(Activity activity, Boolean openHint, String hint) {
        super(activity, R.style.custom_dialog);
        this.activity = activity;
        this.openHint = openHint;
        this.hint = hint;
