...
public class HorizontalExpandMenu extends RelativeLayout {
    ...
    private void init(){
        ...
        defaultWidth = (int) DisplayUtil.dp2px(mContext,200);
        defaultHeight = (int) DisplayUtil.dp2px(mContext,40);
        ...
        menuCornerRadius = typedArray.getDimension(R.styleable.HorizontalExpandMenu_corner_radius, (int) DisplayUtil.dp2px(mContext,20));

        buttonStyle = typedArray.getInteger(R.styleable.HorizontalExpandMenu_button_style,Right);
        buttonIconDegrees = 90;
        buttonIconSize = typedArray.getDimension(R.styleable.HorizontalExpandMenu_button_icon_size, (int) DisplayUtil.dp2px(mContext,8));
