...
//			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.datepicker_divider_dark_gradient_horizontal);
		}
	...
	private void drawCenterRect(Canvas canvas) {
        ...
        if (centerDrawable != null) {
        	 int topOfTopDivider = (getHeight() - ih - 1) / 2;
             int bottomOfTopDivider = topOfTopDivider + 1;
             centerDrawable.setBounds(0, topOfTopDivider, w, bottomOfTopDivider);
             centerDrawable.draw(canvas);

             // draw the bottom divider
             int topOfBottomDivider =  topOfTopDivider + ih;
             int bottomOfBottomDivider = bottomOfTopDivider + ih;
             centerDrawable.setBounds(0, topOfBottomDivider, w, bottomOfBottomDivider);
             centerDrawable.draw(canvas);
        }
