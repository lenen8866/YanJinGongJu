...
public class NewSearchAuthorChapterAdapter extends BaseQuickAdapter<BaseAudioInfo, BaseViewHolder> {
    public NewSearchAuthorChapterAdapter() {
        super(R.layout.item_new_search_audio_book);
    }

    @Override
    protected void convert(BaseViewHolder helper, BaseAudioInfo item) {
        CharSequence author = matchSearch(item.author);
        helper.setText(R.id.tv_book_name, item.chapter)
