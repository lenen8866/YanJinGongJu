...
public class BaikeCategory implements Parcelable {
    ...
    public static final Creator<BaikeCategory> CREATOR = new Creator<BaikeCategory>() {
        public BaikeCategory createFromParcel(Parcel source) {
            return new BaikeCategory(source);
        }

        public BaikeCategory[] newArray(int size) {
            return new BaikeCategory[size];
        }
    };
    ...
    private BaikeCategory(Parcel in) {
        this.id = in.readInt();
