...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, @Nullable AttributeSet attrs) {
        ...
        progressColor = typedArray.getColor(R.styleable.CirclePercentView_circleProgressColor, getResources().getColor(R.color.orange));
        ...
        startColor = typedArray.getColor(R.styleable.CirclePercentView_circleStartColor, Color.parseColor("#ff9800"));
        endColor = typedArray.getColor(R.styleable.CirclePercentView_circleEndColor,Color.parseColor("#ff9800"));
        typedArray.recycle();
        init();
    }
