...
public class CircleTextProgressbar extends AppCompatTextView {
     ...
     * 外部轮廓的颜色。
     */
    private int outLineColor = Color.parseColor("#66000000");
     ...
     * 中心圆的颜色。
     */
    private int circleColor = Color.parseColor("#66000000");
     ...
     * 进度条的宽度。
     */
    private int progressLineWidth = 2;
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        circleColor = typedArray.getColor(R.styleable.CircleTextProgressbar_in_circle_color,circleColor);
        typedArray.recycle();
    }
    ...
    private void validateCircleColor() {
        int circleColorTemp = circleColor;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(bounds.centerX(), bounds.centerY(), outerRadius - DisplayUtil.dp2px(getContext(),outLineWidth), mPaint);

        //画边框圆
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setStrokeWidth(DisplayUtil.dp2px(getContext(),outLineWidth));
        mPaint.setColor(outLineColor);
        canvas.drawCircle(bounds.centerX(), bounds.centerY(), outerRadius - DisplayUtil.dp2px(getContext(),outLineWidth) / 2, mPaint);
        ...
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setStrokeWidth(DisplayUtil.dp2px(getContext(),progressLineWidth));
        mPaint.setStrokeCap(Paint.Cap.ROUND);
        int deleteWidth = (int)DisplayUtil.dp2px(getContext(),progressLineWidth) / 2 ;//+ (int) DisplayUtil.dp2px(getContext(),outLineWidth);
...
//        canvas.drawArc(mArcRect, -90 , 360 + (360 * progress / 100), false, mPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int lineWidth = 4 * (int)(DisplayUtil.dp2px(getContext(),outLineWidth) + progressLineWidth);
    ...
    private Runnable progressChangeTask = new Runnable() {
        ...
        public void run() {
            ...
            progressTime = progressTime + (timeMillis / 100);
            if (progress >= 0 && progress <= 100) {
                if (mCountdownProgressListener != null)
                    mCountdownProgressListener.onProgress(listenerWhat, progress,progressTime);
                invalidate();
    ...
    public interface OnCountdownProgressListener {
         ...
         * @param progress 进度值。
         */
        void onProgress(int what, int progress,long progressTime);
    }
}
