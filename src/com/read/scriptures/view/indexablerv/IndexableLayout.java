package com.read.scriptures.view.indexablerv;
...
import com.read.scriptures.view.indexablerv.database.DataObserver;
import com.read.scriptures.view.indexablerv.database.HeaderFooterDataObserver;
import com.read.scriptures.view.indexablerv.database.IndexBarDataObserver;
...
//    }
     ...
     * @param comparator
     */
    public <T extends IndexableEntity> void setComparator(Comparator<EntityWrapper<? extends IndexableEntity>> comparator) {
        this.mComparator = comparator;
    }
            ...
            public void run() {
                ...
                getSafeHandler().post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mIndexBar.setDatas(false, mRealAdapter.getItems());
...
//                    return lhs.compareTo(rhs);
                    if (isNumeric(lhs)) {
                        if (isNumeric(rhs)) {
                            int index1 = Integer.parseInt(lhs);
                            int index2 = Integer.parseInt(rhs);
                            if (index1 == index2) {
                                return 0;
                            } else {
...
//                }
                    ...
                    entity.setIndex(pinyin.substring(0, 1));
                    entity.setIndexByField(item.getFieldIndexBy());
                }
