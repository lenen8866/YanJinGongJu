...
import static com.read.scriptures.view.BubbleUtils.dp2px;
import static com.read.scriptures.view.BubbleUtils.sp2px;
...
public class BubbleSeekBar extends View {
    ...
    public BubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBubbleView.setProgressText(getProgress(), (int) getMax());
    ...
    private class BubbleView extends View {
        ...
        private int mBubbleViewHeight = 0;
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            mBubblePaint.setTextSize(mBubbleTextSize);
            float v = mBubblePaint.measureText(mProgressText);
            setMeasuredDimension((int) (v + 50), 3 * mBubbleRadius);
            mBubbleViewHeight = (int) (getMeasuredHeight() * 0.42);
            mBubbleRectF.set(0, 0, getMeasuredWidth(), mBubbleViewHeight);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(mBubbleRectF, 15, 15, mBubblePaint);
            ...
            canvas.drawText(mProgressText, getMeasuredWidth() / 2f, mBubbleViewHeight - (fm.bottom - fm.top) / 2 + fm.descent, mBubblePaint);
        }

        void setProgressText(int progressText, int maxProgress) {
            if (progressText < 0) {
                progressText = 0;
            }
            if (maxProgress < 0) {
            ...
            mProgressText = getTimeString(String.valueOf(progressText)) + "/" + getTimeString(String.valueOf(maxProgress));
            invalidate();
        }
    }
