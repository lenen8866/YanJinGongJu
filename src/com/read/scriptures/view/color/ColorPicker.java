package com.read.scriptures.view.color;
...
public class ColorPicker extends RelativeLayout {
    ...
    private void initView(Context context) {
        inflate(context, R.layout.content_color_picker, this);
    ...
    public void setGradientView(int resource) {
        ...
        drawableToBitmap = DrawableUtilities.drawableToBitmap(ContextCompat.getDrawable(getContext(), resource));
    ...
    public void setScreenTouchListener() {
        viewBg.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                int color = drawableToBitmap.getPixel((int) newx, (int) newy);
