 ...
 */
public class CustomRippleDrawableLeft extends Drawable {
    ...
    public CustomRippleDrawableLeft() {
        mPaint = new Paint();
    ...
    public void enter() {
        ...
        mStartPoint.set(bounds.right - 100, 0);
        mControlPoint.set(bounds.right, bounds.bottom / 2);
        mEndPoint.set(bounds.right - 100, bounds.bottom);
        startEnterAnimation();
